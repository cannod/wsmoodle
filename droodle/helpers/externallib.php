...
class droodle_helpers_external extends external_api {
    ...
    public static function list_courses($enrollable_only, $sortby, $guest, $username) { //Don't forget to set it as static
        global $CFG, $DB;
 
      $params = self::validate_parameters(self::list_courses_parameters(), array('enrollable_only'=>$enrollable_only, 'sortby' => $sortby,'guest' => $guest, 'username' => $username)); 
 
		$webservice = new  droodle_webservice ();
		$id = $webservice->list_courses ($enrollable_only, $sortby, $guest, $username);
    ...
    public static function test() { //Don't forget to set it as static
        global $CFG, $DB;
    ...
    public static function my_courses($username, $order_by_cat) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->my_courses ($username, $order_by_cat);
    ...
    public static function get_course_info($id, $username) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_course_info ($id, $username);
    ...
    public static function get_course_contents($id) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_course_contents ($id);
...
//        $params = self::validate_parameters(self::courses_by_category_parameters(), array('id'=>$id));
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->courses_by_category ($category, $enrollable_only, $username);
    ...
    public static function get_course_categories($category) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_course_categories ($category);
    ...
    public static function get_course_editing_teachers($id) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_course_editing_teachers ($id);
    ...
    public static function get_course_no() {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_course_no ();
    ...
    public static function get_enrollable_course_no() {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_enrollable_course_no ();
    ...
    public static function get_student_no() {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_student_no ();
    ...
    public static function get_total_assignment_submissions() {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_total_assignment_submissions ();
    ...
    public static function get_course_students_no($id) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_course_students_no ($id);
    ...
    public static function get_assignment_submissions($id) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_assignment_submissions ($id);
    ...
    public static function get_assignment_grades($id) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_assignment_grades ($id);
    ...
    public static function get_upcoming_events($id) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_upcoming_events ($id);
    ...
    public static function get_news_items($id) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_news_items ($id);
    ...
    public static function get_user_grades($user, $id) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_user_grades ($user, $id);
    ...
    public static function get_course_grade_categories($id) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_course_grade_categories ($id);
    ...
    public static function get_course_grade_categories_and_items($id) {
        ...
        $webservice = new  droodle_webservice ();
        $return = $webservice->get_course_grade_categories_and_items ($id);
   ...
   public static function search_courses_parameters() {
    ...
    public static function search_courses($text, $phrase, $ordering, $limit) {
        ...
        $params = self::validate_parameters(self::search_courses_parameters(), array('text'=>$text, 'phrase'=>$phrase, 'ordering'=>$ordering, 'limit'=>$limit));
 
		$webservice = new  droodle_webservice ();
		$return = $webservice->search_courses ($text, $phrase, $ordering, $limit);
   ...
   public static function search_categories_parameters() {
    ...
    public static function search_categories($text, $phrase, $ordering, $limit) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->search_categories ($text, $phrase, $ordering, $limit);
   ...
   public static function search_topics_parameters() {
    ...
    public static function search_topics($text, $phrase, $ordering, $limit) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->search_topics ($text, $phrase, $ordering, $limit);
    ...
    public static function get_my_courses_grades($username) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_my_courses_grades ($username);
    ...
    public static function check_moodle_users($users) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->check_moodle_users ($users);
    ...
    public static function get_moodle_only_users($users, $search) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_moodle_only_users ($users, $search);
    ...
    public static function get_moodle_users($limitstart, $limit, $order, $order_dir, $search) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_moodle_users ($limitstart, $limit, $order, $order_dir, $search);
    ...
    public static function get_moodle_users_number($search) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_moodle_users_number ($search);
    ...
    public static function user_exists($username) { 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->user_exists ($username);
	...
	/* create_droodle_user_additional */
    public static function create_droodle_user_additional_parameters() {
        return new external_function_parameters(
                        array(
                            'username' => new external_value(PARAM_TEXT, 'username'),
    ...
    public static function create_droodle_user_additional_returns() {
        return new  external_value(PARAM_INT, 'user created');
    }

    public static function create_droodle_user_additional($username, $app) { 
        global $CFG, $DB;
 
        $params = self::validate_parameters(self::create_droodle_user_additional_parameters(), array('username'=>$username, 'app'=>$app));
 
		$webservice = new  droodle_webservice ();
		$id = $webservice->create_droodle_user_additional ($username, $app);
    ...
    public static function multiple_enrol_and_addtogroup($username, $courses, $groups, $roleid) { 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->multiple_enrol_and_addtogroup ($username, $courses, $groups, $roleid);
    ...
    public static function multiple_enrol($username, $courses, $roleid) { 
        ...
        $params = self::validate_parameters(self::multiple_enrol_parameters(), array('username'=>$username, 'courses' => $courses, 'roleid' => $roleid));
 
		$webservice = new  droodle_webservice ();
		$id = $webservice->multiple_enrol ($username, $courses, $roleid);
    ...
    public static function user_details($username) { 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->user_details ($username);
    ...
    public static function user_details_by_id($id) { 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->user_details_by_id ($id);
   ...
   /* migrate_to_droodle */
    public static function migrate_to_droodle_parameters() {
        return new external_function_parameters(
                        array(
                            'username' => new external_value(PARAM_TEXT, 'username')
                        )
    ...
    public static function migrate_to_droodle_returns() {
        return new  external_value(PARAM_BOOL, 'user migrated');
    }
    public static function migrate_to_droodle($username) { 
        global $CFG, $DB;
 
        $params = self::validate_parameters(self::migrate_to_droodle_parameters(), array('username'=>$username));
 
        $webservice = new  droodle_webservice ();
        $id = $webservice->migrate_to_droodle ($username);
   ...
   /* my_events */
    ...
    public static function my_events($username, $courses) { 
        ...
        $webservice = new  droodle_webservice ();
        $id = $webservice->my_events ($username, $courses);
    ...
    public static function get_mentees($username) { 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->get_mentees ($username);
    ...
    public static function get_parents($username) { 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->get_parents ($username);
    ...
    public static function get_site_last_week_stats() {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_site_last_week_stats ();
    ...
    public static function get_course_daily_stats($id) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_course_daily_stats ($id);
    ...
    public static function get_last_user_grades($username, $limit) { 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->get_last_user_grades ($username, $limit);
    ...
    public static function system_check_returns() {
           return new external_single_structure(
                array(
                    'droodle_auth' => new external_value(PARAM_INT, 'droodle plugin enabled'),
 ...
 //                   'enablewebservices' => new external_value(PARAM_INT, 'webservices enabled'),
                    'droodle_configured' => new external_value(PARAM_INT, 'droodle configured'),
    ...
    public static function system_check() {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->system_check ();
    ...
    public static function add_parent_role($child, $parent) { 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->add_parent_role ($child, $parent);
    ...
    public static function get_paypal_config() { 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->get_paypal_config ();
    ...
    public static function update_session($username) {
        ...
        $webservice = new  droodle_webservice ();
        $id = $webservice->update_session ($username);
    ...
    public static function get_cat_name($cat_id) { 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->get_cat_name ($cat_id);
    ...
    public static function courses_abc($start_chars, $username) { 
      ...
      $params = self::validate_parameters(self::courses_abc_parameters(), array('start_chars' => $start_chars, 'username' => $username)); 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->courses_abc ($start_chars, $username);
    ...
    public static function teachers_abc($start_chars) { 
      ...
      $params = self::validate_parameters(self::teachers_abc_parameters(), array('start_chars' => $start_chars)); 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->teachers_abc ($start_chars);
    ...
    public static function teacher_courses($username) { 
      ...
      $params = self::validate_parameters(self::teacher_courses_parameters(), array('username' => $username)); 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->teacher_courses ($username);
    ...
    public static function user_custom_fields() { 
      ...
      $params = self::validate_parameters(self::user_custom_fields_parameters(), array()); 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->user_custom_fields ();
    ...
    public static function course_enrol_methods($id) { 
      ...
      $params = self::validate_parameters(self::course_enrol_methods_parameters(), array('id' => $id)); 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->course_enrol_methods ($id);
    ...
    public static function quiz_get_question($id) { 
      ...
      $params = self::validate_parameters(self::quiz_get_question_parameters(), array('id' => $id)); 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->quiz_get_question ($id);
    ...
    public static function quiz_get_random_question($cat_id, $used_ids) { 
      ...
      $params = self::validate_parameters(self::quiz_get_random_question_parameters(), array('cat_id' => $cat_id, 'used_ids' => $used_ids)); 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->quiz_get_random_question ($cat_id, $used_ids);
    ...
    public static function quiz_get_correct_answer($id) { 
      ...
      $params = self::validate_parameters(self::quiz_get_correct_answer_parameters(), array('id' => $id)); 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->quiz_get_correct_answer ($id);
    ...
    public static function quiz_get_question_categories() {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->quiz_get_question_categories ();
    ...
    public static function quiz_get_answers($id) { 
      ...
      $params = self::validate_parameters(self::quiz_get_answers_parameters(), array('id' => $id)); 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->quiz_get_answers ($id);
    ...
    public static function get_course_students($id) {
        ...
        $webservice = new  droodle_webservice ();
        $return = $webservice->get_course_students ($id);
    ...
    public static function my_teachers($username) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->my_teachers ($username);
    ...
    public static function my_classmates($username) {
        ...
        $webservice = new  droodle_webservice ();
        $return = $webservice->my_classmates ($username);
    ...
    public static function multiple_suspend_enrolment($username, $courses) { 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->multiple_suspend_enrolment ($username, $courses);
    ...
    public static function suspend_enrolment($username, $id) {
        ...
        $webservice = new  droodle_webservice ();
        $id = $webservice->suspend_enrolment ($username, $id);
    ...
    public static function get_course_resources($id, $username) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_course_resources ($id, $username);
    ...
    public static function get_course_mods($id, $username) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_course_mods ($id, $username);
    ...
    public static function get_course_completion($id, $username) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_course_completion ($id, $username);
    ...
    public static function get_course_quizes($id, $username) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_course_quizes ($id, $username);
    ...
    public static function my_certificates($username) {
        global $CFG, $DB;

        $params = self::validate_parameters(self::my_certificates_parameters(), array('username'=>$username));

        $webservice = new  droodle_webservice ();
        $return = $webservice->my_certificates ($username);
    ...
    public static function get_label($id) {
        ...
        $webservice = new  droodle_webservice ();
        $return = $webservice->get_label ($id);
    ...
    public static function get_news_item($id) {
        ...
        $webservice = new  droodle_webservice ();
        $return = $webservice->get_news_item ($id);
    ...
    public static function get_my_news($username) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_my_news ($username);
    ...
    public static function get_my_events($username) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_my_events ($username);
    ...
    public static function get_my_grades($username) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_my_grades ($username);
    ...
    public static function get_course_grades_by_category($id, $username) {
        ...
        $webservice = new  droodle_webservice ();
        $return = $webservice->get_course_grades_by_category ($id, $username);
    ...
    public static function get_my_grades_by_category($username) {
        ...
        $webservice = new  droodle_webservice ();
        $return = $webservice->get_my_grades_by_category ($username);
    ...
    public static function add_cohort_member($username, $cohort_id) { 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->add_cohort_member ($username, $cohort_id);
    ...
    public static function get_rubrics($id) {
        ...
        $webservice = new  droodle_webservice ();
        $return = $webservice->get_rubrics ($id);
    ...
    public static function get_grade_user_report($id, $username) {
        ...
        $webservice = new  droodle_webservice ();
        $return = $webservice->get_grade_user_report ($id, $username);
    ...
    public static function get_my_grade_user_report($username) {
        ...
        $webservice = new  droodle_webservice ();
        $return = $webservice->get_my_grade_user_report ($username);
    ...
    public static function teacher_get_course_grades($id, $search) {
        ...
        $params = self::validate_parameters(self::teacher_get_course_grades_parameters(), array('id'=>$id, 'search' => $search));

        $webservice = new  droodle_webservice ();
        $return = $webservice->teacher_get_course_grades ($id, $search);
    ...
    public static function get_group_members($id, $search) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_group_members ($id, $search);
    ...
    public static function get_course_groups($id) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_course_groups ($id);
    ...
    public static function teacher_get_group_grades($course_id, $group_id, $search) {
        ...
        $webservice = new  droodle_webservice ();
        $return = $webservice->teacher_get_group_grades ($course_id, $group_id, $search);
    ...
    public static function create_course($course) {
        ...
        $webservice = new  droodle_webservice ();
        $return = $webservice->create_course ($course);
    ...
    public static function update_course($course) {
        ...
        $webservice = new  droodle_webservice ();
        $return = $webservice->update_course ($course);
    ...
    public static function add_user_role($username, $id, $roleid) { 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->add_user_role ($username, $id, $roleid);
    ...
    public static function get_course_parents($id) {
        ...
        $webservice = new  droodle_webservice ();
        $return = $webservice->get_course_parents ($id);
    ...
    public static function get_all_parents() {
        ...
        $webservice = new  droodle_webservice ();
        $return = $webservice->get_all_parents ();
    ...
    public static function remove_cohort_member($username, $cohort_id) { 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->remove_cohort_member ($username, $cohort_id);
    ...
    public static function multiple_add_cohort_member($username, $cohorts) { 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->multiple_add_cohort_member ($username, $cohorts);
    ...
    public static function multiple_remove_cohort_member($username, $cohorts) { 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->multiple_remove_cohort_member ($username, $cohorts);
    ...
    public static function get_courses_and_groups() {
      ...
      $params = self::validate_parameters(self::get_courses_and_groups_parameters(), array()); 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->get_courses_and_groups ();
    ...
    public static function multiple_enrol_to_course_and_group($username, $courses, $roleid) { 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->multiple_enrol_to_course_and_group ($username, $courses, $roleid);
    ...
    public static function multiple_remove_from_group($username, $courses) { 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->multiple_remove_from_group ($username, $courses);
    ...
    public static function my_all_courses($username) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->my_all_courses ($username);
    ...
    public static function multiple_unenrol_user($username, $courses) { 
		...
		$webservice = new  droodle_webservice ();
		$id = $webservice->multiple_unenrol_user ($username, $courses);
    ...
    public static function unenrol_user($username, $id) {
        ...
        $webservice = new  droodle_webservice ();
        $id = $webservice->unenrol_user ($username, $id);
    ...
    public static function get_children_grades($username) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_children_grades ($username);
    ...
    public static function get_children_grade_user_report($username) {
		...
		$webservice = new  droodle_webservice ();
		$return = $webservice->get_children_grade_user_report ($username);
